...
export default {
  ...
  methods: {
    ...
    async getProducts() {
      try {
        const response = await axios.get("https://banxedap-backend-api.onrender.com/api/products");
    ...
    async deleteProduct(id) {
      try {
        await axios.delete(`https://banxedap-backend-api.onrender.com/api/products/${id}`);
        this.getProducts();
      } catch (err) {
        console.log(err);
      }
    ...
    onSubmit(){
      ...
      axios.post('https://banxedap-backend-api.onrender.com/api/products',formData,{
      }).then((res)=>{
        console.log(res)
      })
    },  
    ...
    onSubmitupdate(){
      ...
      formData.append('qty', this.qty)
      formData.append('cat_id', this.cat_id)
      axios.put(`https://banxedap-backend-api.onrender.com/api/products/${this.productid}`,formData,{
      }).then((res)=>{
        console.log(res)
      })
    },  
          ...
          async getCategory() {
        try {
          const response = await axios.get("https://banxedap-backend-api.onrender.com/api/category");
